...
`share3` thì được truy cập bởi admin và user3, share4 được truy cập bởi tất cả mọi người.</br>
...
- `share4` được truy cập bởi tất cả mọi người.
...
Trong ví dụ của chúng tôi ở trên, chúng tôi sẽ chia sẻ các tệp và thư mục Linux cho các máy khách Windows. Vì Windows và Linux sử dụng cách tiếp cận khác nhau để cấp quyền và thuộc tính tệp, Samba sẽ đảm nhiệm việc ánh xạ hai cách tiếp cận.</br>
