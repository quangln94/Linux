...
<li>Đây là hệ thống tập tin giả có chứa thông tin về các quá trình đang chạy. chẳng hạn như thư mục `/proc/{pid}` có chứa thông tin về quá trình đặc biệt của `pid`.<li>
