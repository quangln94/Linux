...
**– Root `/`**
<ul>
<li>Mở từng tập tin và thư mục từ thư mục Root.</li>
<li>Chỉ có Root user mới có quyền viết dưới thư mục này.</li>
</ul>
</br> *Lưu ý rằng `/root` là thư mục gốc của Root user.*
**– User Binaries `/bin`**
<ul>
